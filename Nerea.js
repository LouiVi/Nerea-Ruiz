...
function CreateActionBar()
{
    ...
    //Create title.
    txtBarTitle = app.CreateText( "Nerea Ramírez", -1,-1, "Left" );
...
function CreateDrawer()
{
	...
	var img = app.CreateImage( "Img/Nerea Ruiz.png", 0.65 );
	img.SetMargins( 0.02,0.02,0.02,0.01 );
	layDrawerTop.AddChild( img );
	
	//Add app name to top layout.
	var txtName = app.CreateText( "Nerea Ramírez",-1,-1,"Bold");
    ...
    lstMenuMain.SetItemByIndex( 0, "Nerea Ramírez" );
